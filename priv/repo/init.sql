...
SELECT change_column_with_function('commons', 'currency', 'character varying(3)', 'currency_conversion');
...
ALTER TABLE customers_demo ALTER COLUMN meta_attributes TYPE jsonb USING meta_attributes::jsonb;
