defmodule Siwapp.InvoicesTest do
  ...
  describe "Statistics.get_amount_per_day/1" do
    ...
    test "for two invoices in the same day, it returns one unique value with the sum of its amounts", %{today: today} do
      invoice_fixture(%{issue_date: today, items: [valid_item_attributes(%{unitary_cost: 500, discount: 0, taxes: []})]})
      invoice_fixture(%{issue_date: today, items: [valid_item_attributes(%{unitary_cost: 500, discount: 0, taxes: []})]})
